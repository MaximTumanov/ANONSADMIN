	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="100"><?php echo JText::_('Email')?></th>
				<th width="250"><?php echo JText::_('Организатор')?></th>
				<th width="80"><?php echo JHTML::_('grid.sort', 'Запрос', 'c.new', @$lists['order_Dir'], @$lists['order'] ); ?></th>
		...
		<tbody>
			<?php foreach($this->items as $item):?>
					<?php 
						...
						$link_request = ($item->new == 1) ? "<img src='images/publish_x.png' />" : "<img src='images/tick.png' />";
			...
			<?php endforeach;?>
			<tr>
				<td colspan="12" align="center" style="background-color:#F0F0F0"><?php echo $page->getListFooter(); ?></td>
			</tr>
		</tbody>		
	</table>
</div>
