	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="350"><?php echo JText::_('Адрес')?></th>
				<th width="200"><?php echo JText::_('Телефон')?></th>
		...
		<tbody>
			<?php if($this->items): foreach($this->items as $item):?>
					<?php 
						...
						$link_to_site = "index.php?option=com_cinema&layout=item&id={$id}&Itemid=35";
					...
					<tr class="row<?php echo ($i%2) ? 0 : 1;?>">
                        ...
                        <td>
                        	...
                        	<p class='show' style="margin:0; padding:0"><a title="Посмотреть '<?php echo $item->title;?>' на сайте" target="blank" style="color: #666" href="http://anons.dp.ua/cinema/show/<?php echo $item->alias?>">посмотреть на сайте ></a></p>
                        </td>
