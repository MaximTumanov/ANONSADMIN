...
$placeList  = EventsHelper::selectList($model->getPlaceList(), 'id_place', 'Выбирите организатора', $id_place);
$catList    = EventsHelper::selectListMulti($model->getCategory(), 'id_category', $id_category);

$hoursList  = EventsHelper::selectLists($hours, 'hour', '00', $hour);
$minutsList = EventsHelper::selectLists($minutes, 'minut', '00', $minute);
$daysList   = EventsHelper::selectLists($days, 'day', '0', $day);
$datesList  = EventsHelper::selectLists($datess, 'day', '0', $day);

$vipList    = EventsHelper::selectYN($vip, 'vip');
$pubList    = EventsHelper::selectYN($published, 'published');
$wtfList    = EventsHelper::selectLists($wtfs, 'wtf', '0', $wtf);
